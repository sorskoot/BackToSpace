...
void main() {
   ...
   Material mat = decodeMaterial(fragMaterialId);  
    ...
    float dist = (1.0-gl_FragCoord.w*5.0);
    float fogFactor = dist;//fogFactorExp2(dist, 0.5);
    ...
    float t1Threshold = 0.1; // change this to your desired threshold
    float t2Threshold = 0.5; // change this to your desired threshold
    float t3Threshold = 0.95; // change this to your desired threshold
